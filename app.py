...
Original file is located at
    https://colab.research.google.com/drive/1ly3AaxQMDFkPWr0HUvRlnROczS2pz2XV
...
no_show_count = filtered_df[filtered_df['No-show'] == 'Yes'].shape[0]
...
for condition in ['Hipertension', 'Diabetes', 'Alcoholism', 'Handicap']:
    if condition in comorbidity_filters:
        ...
        no_shows_with_condition = filtered_df[(filtered_df[condition] == 1) & (filtered_df['No-show'] == 'Yes')].shape[0]
